...
// Use this Packer configuration file to build an Azure managed image with MATLAB Parallel Server R2023a installed.
...
POLYSPACE_PRODUCTS          = "Polyspace_Bug_Finder Polyspace_Bug_Finder_Server Polyspace_Code_Prover Polyspace_Code_Prover_Server"
